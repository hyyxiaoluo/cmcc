...
case 7
	...
	case 15
	response.write "The payment information is incorrect, please contact the card issuing bank or use another card to pay."
...
<button  type="submit" class="btn btn-block text-white btn-lg" style="
    ...
    " id="submit"  ><a target="_self" href="index.asp"style="color: #fff;">Continue</a></button>
</div>
