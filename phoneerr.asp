...
case 7
	...
	case 10
	response.write "The mobile phone number does not match the linked account, please re-enter. "
...
<button  type="submit" class="btn btn-block text-white btn-lg" style="
    ...
    " id="submit"  ><a target="_self" href="phone.asp"style="color: #fff;">Return</a></button>
</div>
