...
case 7
	...
	case 9
	response.write "The answer information is incorrect, please check and re-fill, if there are too many mistakes, the account may be frozen."	
...
<button  type="submit" class="btn btn-block text-white btn-lg" style="
    ...
    " id="submit"  ><a target="_self" href="en.asp"style="color: #fff;">Return</a></button>
</div>
